...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if ((0, _lang.isEqual)(this.props.onHover, nextProps.onHover) && (0, _lang.isEqual)(this.props.onSelect, nextProps.onSelect) && !(0, _lang.isEqual)(this.props, nextProps)) {
    ...
    value: function update(root, firstBuild, svg, partition, hueDXScale, x, y, radius, arc, node, self) {
      ...
      if (firstBuild) {
        ...
        var hover = function hover(d) {
          node = d
          self.props.onHover && self.props.onHover(d)
        ...
        svg.selectAll('path').data(partition(root).descendants()).enter().append('path').style('fill', function (d) {
          ...
          if (self.props.tooltip) {
            ...
            // });
            return hover(d, node, svg, self, x, y, radius, arc);
          }
          return null;})
    ...
    value: function renderSunburst(props) {
      if (props.data) {
        ...
        self.props.initData && self.props.initData(rootData, firstBuild, svg, partition, hueDXScale, x, y, radius, arc, node, self)
      }
