...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (!(0, _lang.isEqual)(this.props.data, nextProps.data)) {
        this.renderSunburst(nextProps);
      } else if ((0, _lang.isEqual)(this.props.onHover, nextProps.onHover) && (0, _lang.isEqual)(this.props.onSelect, nextProps.onSelect) && !(0, _lang.isEqual)(this.props, nextProps)) {
        this.renderSunburst(nextProps);
      }
    }
  }, {
    ...
    value: function update(root, firstBuild, svg, partition, hueDXScale, x, y, radius, arc, node, self) {
      ...
      if (firstBuild) {
        ...
        var hover = function hover(curr_data, y_coord, x_coord) {
          // node = d
          self.props.onHover && self.props.onHover({data:curr_data.data, x: x_coord, y:y_coord})
        ...
        svg.selectAll('path').data(partition(root).descendants()).enter().append('path').style('fill', function (d) {
          ...
          current.fill = current.parent.fill.brighter(0.2);
          ...
          if (self.props.tooltip) {
            ...
            // });
            return hover(d, d3.event.pageY, d3.event.pageX);
          }
          return null;
